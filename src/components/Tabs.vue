...
<script>
  ...
  import setNav from '../views/base/SetNav'
  import mineInfo from '../views/base/MineInfo'
  import quillEditor from "../views/QuillEditor"
  import articleManager from "../views/base/ArticleManager"
  import mail from "../views/base/Mail"
  import homeUpdatePass from "../views/base/HomeUpdatePass"
  import profile from "../views/base/Profile"
